/* Filter drawer — slides in from the right (Crosscoin pattern, Gripzus
   athletic-mono design). Price range · Size · Colour. Options are dynamic —
   derived from the actual products on the page. Prop-driven & controlled. */
    ...
    <>
      ...
      >
        <div className="flex items-center justify-between px-6 py-5 border-b-2 border-ink">
          <h2 className="h-mark text-2xl text-ink">Refine</h2>
        ...
        <div className="flex-1 overflow-y-auto px-6 py-7 space-y-9">
            ...
            <div className="lg:hidden">
              ...
              <div className="flex flex-wrap gap-2">
                <button
                  ...
                  className={`px-4 py-2.5 text-[11px] font-bold tracking-[0.14em] uppercase border-2 transition-colors ${
          ...
          {/* Price */}
          <div>
            <p className="kicker mb-4">Price range</p>
            <div className="flex items-center gap-3">
              <div className="flex-1">
                <label className="text-[10px] font-bold tracking-[0.2em] uppercase text-ink-muted block mb-2">Min ₹</label>
                <input
              ...
              <span className="text-ink-muted mt-6">—</span>
              <div className="flex-1">
                <label className="text-[10px] font-bold tracking-[0.2em] uppercase text-ink-muted block mb-2">Max ₹</label>
                <input
          ...
          {sizeOptions.length > 0 && (
            <div>
              <p className="kicker mb-4">Size</p>
              <div className="flex flex-wrap gap-2">
                {sizeOptions.map((s) => (
                  <button
                    key={s}
                    ...
                    className={`min-w-[3rem] px-3 py-2.5 text-[12px] font-bold uppercase border-2 transition-colors ${
          ...
          {colorOptions.length > 0 && (
            <div>
              <p className="kicker mb-4">Colour</p>
                ...
                {colorOptions.map((c) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      />
                      <span className={`text-[12px] font-bold tracking-[0.1em] uppercase transition-colors ${checked ? 'text-ink' : 'text-ink-soft group-hover:text-ink'}`}>
                        {c.name}
                      </span>
                    </button>
                  );
        ...
        <div className="border-t-2 border-ink px-6 py-4 flex items-center gap-3">
