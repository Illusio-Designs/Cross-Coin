/**
 * Product feed  →  /google-merchant.xml   (Google Merchant Center)
 *
 * Server-generated RSS 2.0 feed (g: namespace). Google Merchant Center and Meta
 * Commerce Manager both accept this format. /facebook-catalog.xml serves the
 * same feed under a Meta-friendly URL. Brand-scoped via X-Brand-Name.
 */
const BRAND = process.env.NEXT_PUBLIC_BRAND_NAME || '__SLUG__';
const BASE_URL = process.env.NEXT_PUBLIC_SITE_URL || 'https://__DOMAIN__';
const API_URL = process.env.NEXT_PUBLIC_API_URL || 'https://api.crosscoin.in';
const IMAGEKIT = process.env.NEXT_PUBLIC_IMAGEKIT_URL_ENDPOINT || 'https://ik.imagekit.io/wp2oatzmf';

const DEFAULT_BRAND = process.env.NEXT_PUBLIC_SITE_NAME || '__NAME__';
