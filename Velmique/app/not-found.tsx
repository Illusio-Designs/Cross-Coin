  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-6 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        <img src="https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=1600&q=60"
      ...
      <div className="relative z-10 text-center max-w-lg">
        ...
        <div className="-mt-8 mb-6">
          <h1 className="font-serif text-4xl text-cream">Page Not Found</h1>
          <div className="gold-divider w-16 mx-auto mt-4" />
        </div>
        <p className="text-cream/50 font-body text-sm leading-relaxed mb-10">
