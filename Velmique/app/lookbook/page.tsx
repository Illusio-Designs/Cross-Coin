...
const lookbookItems = [
  { image: 'https://images.unsplash.com/photo-1541643600914-78b084683702?w=800&q=80', title: 'Noir Absolu', col: 'md:col-span-2 md:row-span-2' },
  ...
  { image: 'https://images.unsplash.com/photo-1541643600914-78b084683702?w=600&q=80', title: 'Obsidian Rose', col: '' },
      ...
      <div className="relative h-80 overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center text-center">
          <div>
            ...
            <p className="text-cream/50 text-sm font-body mt-3">Fragrance Editorial 2026</p>
          </div>
        </div>
      </div>
