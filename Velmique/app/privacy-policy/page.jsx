    ...
    <div className="pt-8 min-h-screen">
      <div className="max-w-7xl mx-auto px-6 md:px-10 lg:px-14 py-10">
        <div className="mb-12">
          ...
          <h1 className="font-serif text-4xl text-[#f3ede0]">Privacy Policy</h1>
          <div className="gold-divider w-16 mt-4" />
          <p className="text-[#f3ede0]/40 text-xs font-body mt-4">Last updated: March 1, 2026</p>
        </div>

        <p className="text-[#f3ede0]/60 font-body text-sm leading-loose mb-10">
        ...
        <div className="space-y-10">
          {sections.map((s, i) => (
            <section key={s.title}>
              ...
              {s.content.split('\n\n').map((para, j) => (
                <p key={j} className="text-[#f3ede0]/55 font-body text-sm leading-loose mb-3">{para}</p>
              ))}
            </section>
          ))}
        </div>
