  ...
  return (
    <div className="pt-32 min-h-screen flex items-center justify-center px-6">
      <div className="text-center max-w-lg">
        ...
        <p className="text-[#C9A84C] text-xs tracking-[0.4em] uppercase font-body mb-3">Order Placed</p>
        <h1 className="font-serif text-4xl text-cream mb-4">Thank You</h1>
        <div className="gold-divider w-16 mx-auto mb-6" />
        <p className="text-cream/50 font-body text-sm leading-relaxed mb-2">
          Your order <span className="text-[#C9A84C]">#VLQ-{Math.floor(Math.random() * 90000) + 10000}</span> has been placed and is being prepared with care.
        </p>
        <p className="text-cream/40 font-body text-xs mb-10">A confirmation email will be sent to your address.</p>
