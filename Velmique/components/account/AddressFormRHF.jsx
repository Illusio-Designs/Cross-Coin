...
/**
 * RHF + Zod address form. See Knitwink for full rationale.
 *
 * Velmique uses Cream/Gold palette for inputs (cf. globals.css).
 * Drop in any account or future-checkout flow:
 *
 *   <AddressFormRHF defaultValues={existing} onSubmit={save} />
 */
