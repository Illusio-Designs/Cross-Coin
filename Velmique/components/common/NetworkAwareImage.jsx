...
/**
 * Connection-aware <Image>.
 *
 * On save-data / 2g, renders a tap-to-load placeholder instead of
 * downloading the full-res asset. Once tapped (or on a faster
 * connection) it renders next/image with the variant best matching
 * the bandwidth.
 *
 * `variants` shape: { thumb, small, medium, large } — strings.
 * `fallbackSrc` is rendered when nothing else is available.
 */
