...
- [x] 2. Implement the 7 Sequelize models
  - [x] 2.1 Create `Backend/model/blogCategoryModel.js`
  ...
  - [x] 2.2 Create `Backend/model/blogPostModel.js`
  ...
  - [x] 2.3 Create `Backend/model/blogTagModel.js`
  ...
  - [x] 2.4 Create `Backend/model/blogPostTagModel.js`
  ...
  - [x] 2.5 Create `Backend/model/blogBrandModel.js`
  ...
  - [x] 2.6 Create `Backend/model/blogFeaturedProductModel.js`
  ...
  - [x] 2.7 Create `Backend/model/blogSeoModel.js`
...
- [x] 6. Implement `blogController.js` — categories CRUD
...
- [x] 7. Implement `blogController.js` — blog post CRUD
  - [x] 7.1 Implement `createPost`
  ...
  - [x] 7.5 Implement `getAllPostsAdmin`
...
- [x] 8. Implement `blogController.js` — public API
  - [x] 8.1 Implement `getPublicPosts`
  ...
  - [x] 8.4 Implement `getPublicPostBySlug`
...
- [x] 9. Implement `blogController.js` — hero image upload
...
- [x] 12. Mount blog routes in `routesManager.js`
...
- [x] 13. Write unit tests in `blog.unit.test.js`
