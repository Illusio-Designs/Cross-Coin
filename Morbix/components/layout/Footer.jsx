        ...
        <div className="footer-cols">
          <div className="brand-col">
            ...
            <div className="socials">
              <a href="https://www.instagram.com/morb.ix_socks/" target="_blank" rel="noopener noreferrer" aria-label="Morbix on Instagram"><Icon name="Instagram" size={18} /></a>
              <a href="https://www.facebook.com/profile.php?id=61584727552983" target="_blank" rel="noopener noreferrer" aria-label="Morbix on Facebook"><Icon name="Facebook" size={18} /></a>
