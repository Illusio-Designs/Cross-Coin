/**
 * Morbix wordmark — a vector rendition of the brand logo:
 ...
 * this component's usage with <img src="/logo.webp" alt="Morbix" />.
 */
export default function MorbixLogo({ height = 30, className = '' }) {
  return (
    <svg
      className={className}
      height={height}
