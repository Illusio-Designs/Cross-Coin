...
export function BestsellerRow({ products = [] }) {
  ...
  return (
    <section className="bg-gray-50 py-12">
      <div className="mb-6 flex items-center justify-between px-4 md:px-8 lg:px-16">
        <div className="flex-1" />
        <SectionHeader eyebrow="Most Loved" title="Flying Off the <strong>Shelves</strong>" center />
      ...
      {products.length === 0 ? (
        <div className="flex gap-3 overflow-hidden px-4 md:px-8 lg:px-16">
        ...
        <div ref={emblaRef} className="overflow-hidden">
          <div className="flex gap-3 px-4 md:px-8 lg:px-16">
