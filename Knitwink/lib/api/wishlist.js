...
const GUEST_TOKEN_KEY = 'knitwink:guestToken';
...
/* Normalise a backend wishlist row into the shape the Knitwink UI uses.
   Knitwink's WishlistPageClient renders product.images, product.variants,
