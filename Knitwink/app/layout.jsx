...
// Required because Next 16 + Turbopack hits a TDZ in the minified SSR
// chunk for any page that pulls heavy client modules through the
// layout. Runtime perf is unaffected — Next still streams + RSCs the
// response, just without a build-time HTML cache.
