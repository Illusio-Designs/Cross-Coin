          ...
          <div className="flex flex-col gap-6">
            ...
            <div>
              ...
              <div className="flex items-center gap-3">
                <a href="https://www.instagram.com/knitwink/" target="_blank" rel="noopener noreferrer" aria-label="Instagram"
                ...
                <a href="https://www.facebook.com/profile.php?id=61592007865725" target="_blank" rel="noopener noreferrer" aria-label="Facebook"
                  className="flex h-10 w-10 items-center justify-center rounded-full border border-gray-200 text-brand-black transition-all hover:bg-brand-black hover:text-white hover:border-brand-black">
                  <Facebook size={16} />
                </a>
