/* Wishlist API — mirrors Knitwink/lib/api/wishlist.js for the Soxbae brand.
...
const GUEST_TOKEN_KEY = 'soxbae:guestToken';
...
/** Normalise a backend wishlist row into the Soxbae product-card shape. */
