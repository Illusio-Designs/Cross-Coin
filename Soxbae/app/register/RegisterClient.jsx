...
export default function RegisterClient() {
  ...
  // account without MSG91, until the Soxbae domain is whitelisted in MSG91.
  // SECURITY: set to false before real launch (while true anyone can register
  // with 1111).
  const OTP_TEST_MODE = false; // live: real MSG91 OTP (1111 test-bypass off)
    ...
    try {
      ...
      await fetch(`${API_URL}/api/users/register`, {
        ...
        body: JSON.stringify({
          ...
          email: form.email.trim() || `${digits}@phone.soxbaesocks.com`,
          phone: digits,
        ...
        <div className="contact-form auth-form">
          {step === 'details' ? (
            ...
            <form onSubmit={handleVerify}>
              ...
              <button type="button" className="link-more" style={{ width: '100%', justifyContent: 'center', textAlign: 'center', marginTop: 4 }}
