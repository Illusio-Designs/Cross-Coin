...
export default function LoginClient() {
  ...
  // WITHOUT MSG91, until the Soxbae domain is whitelisted in the MSG91 widget.
          ...
          {step === 'phone' ? (
            <>
              ...
              <p className="muted" style={{ textAlign: 'center', fontSize: 13 }}>
                New to Soxbae? <Link href="/register" style={{ color: 'var(--navy)', fontWeight: 600 }}>Create an account</Link>
              </p>
            </>
          ) : (
            <>
