  ...
  return (
    <div className="container" style={{ paddingTop: 34, paddingBottom: 20 }}>
      <div className="page-hero">
        ...
        <p>Soxbae makes premium socks for people who move — runners, athletes and city dwellers alike. We obsess over the details most brands ignore: the arch band that stays put, the toe seam you never feel, the knit that breathes.</p>
      </div>
      ...
      <div className="about-band">
        <div>
          ...
          <p>From the first prototype to the pair on your feet, every Soxbae sock is tested by real athletes and refined until it disappears — so all you notice is the run, the game, or the walk home.</p>
        </div>
      </div>
    </div>
  );
