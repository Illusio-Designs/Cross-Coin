...
const FRONTEND_URL = process.env.NEXT_PUBLIC_FRONTEND_URL || 'https://velquira.com';
const API_URL      = process.env.NEXT_PUBLIC_API_URL      || 'https://api.crosscoin.in';

const TAG_PREFIX = 'velquira-seo-';
...
export default function SeoWrapper({ pageName, seoData, children }) {
  ...
  const defaults = useMemo(() => ({
    meta_title: 'Velquira',
    meta_description: 'Premium knitwear from Velquira — small-batch knit goods made with care.',
    meta_keywords: 'velquira, knitwear, premium socks, handcrafted',
    canonical_url: null,
    meta_image: null,
  }), []);
