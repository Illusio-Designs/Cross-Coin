...
const styles = {
  ...
  title: { fontSize: '28px', fontWeight: 700, color: '#2a2318', margin: '0 0 12px 0' },
  ...
  buttonPrimary: { background: '#2a2318', color: '#fff' },
  buttonSecondary: { background: '#8B7355', color: '#fff' },
  buttonGhost: { background: '#fff', color: '#2a2318', borderColor: '#e5e7eb' },
