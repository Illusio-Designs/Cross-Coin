 ...
 * editors that get rendered with dangerouslySetInnerHTML.
 *
 *   richHtml(html)   — full prose (p, h*, ul, blockquote, a, img, table)
 *   inlineHtml(html) — formatting tags only (strong, em, mark)
 *   installLinkHardening() — external links → target=_blank rel=noopener
 *
 * Self-generated content (JSON-LD, analytics snippets, bootstrap
 * scripts) does NOT need DOMPurify — they're not user-authored.
 */
