...
import { Add01Icon, MinusSignIcon, Delete02Icon, Search01Icon } from '@hugeicons/core-free-icons';

const IC = {
  plus: <HugeiconsIcon icon={Add01Icon} size={14} strokeWidth={2} />,
  minus: <HugeiconsIcon icon={MinusSignIcon} size={14} strokeWidth={2} />,
  trash: <HugeiconsIcon icon={Delete02Icon} size={14} strokeWidth={2} />,
  search: <HugeiconsIcon icon={Search01Icon} size={14} strokeWidth={2} />,
};
