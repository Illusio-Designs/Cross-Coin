    ...
    <Html lang="en">
      <Head>
        ...
        {/* ── Facebook Pixel (server-rendered) ──
            Guarded like gtag above: the admin dashboard (Obzus) and auth pages
            must NOT load or fire the pixel — otherwise staff browsing is tracked
            as customer PageViews and pollutes the storefront's Pixel data. */}
        {fbId && (
          <script
            dangerouslySetInnerHTML={{
              __html:
