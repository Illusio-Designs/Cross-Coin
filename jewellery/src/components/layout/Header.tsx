    ...
    <>
      <header
        className={`sticky top-0 z-50 bg-white transition-all duration-200 ${
          isScrolled ? 'shadow-md border-b border-gold/20' : ''
        }`}
      >
        <div className="container-custom">
          <div className="flex items-center justify-between h-20">
            ...
            <nav className="hidden lg:flex items-center space-x-8">
              ...
              <Link href="/collections/new-arrivals" className="link-hover font-medium">
                New Arrivals
              </Link>
            ...
            <div className="py-4 border-t animate-fade-in">
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 pr-10 border border-gold/30 focus:outline-none focus:border-gold"
                  autoFocus
                />
                <button
