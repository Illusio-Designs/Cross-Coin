      ...
      {isOpen && (
        <>
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto p-6">
              {items.length === 0 ? (
                <div className="flex flex-col items-center justify-center h-full text-center">
                  ...
                  <p className="text-muted mb-6">Discover our exquisite collection</p>
                ...
                <div className="space-y-4">
                  {items.map((item) => (
                    <div key={item.id} className="flex gap-4 pb-4 border-b border-gold/10">
            ...
            {/* Footer */}
            {items.length > 0 && (
              <div className="border-t border-gold/20 p-6 space-y-4 bg-gray-50">
